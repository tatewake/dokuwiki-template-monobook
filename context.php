...
if ($pagetype == "article")
{
	...
	$monobook['content_actions']['edit']['href'] = DOKU_BASE.DOKU_SCRIPT."?id=".$ID."&amp;do=edit&amp;rev=".$requestREV;
	...
	if($INFO['writable'])
	{
		if($INFO['draft'])
		{
			$monobook['content_actions']['edit']['href'] = DOKU_BASE.DOKU_SCRIPT."?id=".$ID."&amp;do=draft&amp;rev=".$requestREV;
